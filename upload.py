...
def draw_graph1_and_upload(str,str2):
    ...
    font = ImageFont.truetype("./font/MSJHBD.TTC",40, encoding="utf-8")
    ...
    draw.text(((imgwidth/4-(right1-left1)/2),30),str,'#000000',font)
    draw.text(((imgwidth/4-(right2-left2)/2) + imgwidth/2,30),str2,'#000000',font)
